...
* +D -- where D is the depth of the deepest
recipe chain where all recipes are theme-cohesive.
(This is hard to explain, see the
visual examples...)  Max +10.
